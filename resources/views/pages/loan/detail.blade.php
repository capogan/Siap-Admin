...
{{--                                    </ul>--}}
        ...
        <div class="row">
	        <div class="x_panel" style="">
		        <div class="x_title">
			        <h2>Verifikasi Telepon 																
				    <small> Sedang di Proses : Verifikasi Pekerjaan Calon Peminjam</small>
			    </h2>
			<ul class="nav navbar-right panel_toolbox">
				<li>
							...
							<tr>
								...
								<td>
									<button type="button" class="btn btn-info btn-sm">
										<i class="fa fa-volume-up"></i> rekaman
				...
				<div class="row mt-5">
					<div class="col-sm-3">
						<button type="button" class="btn btn-warning">
							<i class="fa fa-share"></i> Lanjutkan Proses
			...
			<div class="container">
				<div class="row">
					<div class="col">
						<div class="row">
							<div class="col">
								<p>Nomor  Telepon Tempat Usaha</p>
							</div>
							<div class="col">
								<p>0216549873</p>
							</div>
							<div class="col">
								<input type="checkbox" class="flat"> Sama
							</div>
							<div class="col">
								<input type="checkbox" class="flat"> Beda
							</div>
							<div class="col">
								...
								<div class="row mt-2">
									...
									<div class="row mt-2">
										...
										<div class="row mt-2">
											...
											<div class="row mt-2">
												<div class="col">
													<p>Detail Jenis Bidang Usaha</p>
												</div>
												<div class="col">
													<p>Distributor Kvision</p>
												</div>
												<div class="col">
													<input type="checkbox" class="flat"> Sama
												</div>
												...
												<div class="row mt-2">
													...
													<div class="row mt-2">
														<div class="col">
															<p>Status Tempat Usaha</p>
														</div>
														<div class="col">
															<p>Kontrak per bulan</p>
														</div>
														<div class="col">
															<input type="checkbox" class="flat"> Sama
														</div>
														...
														<div class="row mt-2">
															<div class="col">
																<p>rata Pendapatan penjualan Perbulan dalam 6 bulan terakhir</p>
															</div>
															<div class="col">
																<p>0216549873</p>
															</div>
															...
															<div class="row mt-2">
																...
																<div class="row mt-2">
																	<div class="col">
																		<p>rata - rata Pengeluaran Perbulan dalam  dalam 6 bulan terakhir</p>
																	</div>
																	<div class="col">
																		<p>10.000.000</p>
																	</div>
																	...
																	<div class="row mt-2">
																		<div class="col">
																			<p>rata-rata Keuntungan perbulan  dalam 6 bulan terakhir</p>
																		</div>
																		<div class="col">
																			<p>2.500.000</p>
																		</div>

        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <ul class="nav nav-tabs justify-content-end bar_tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile1" role="tab" aria-controls="profile" aria-selected="false">Detail Score</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="home1" role="tabpanel" aria-labelledby="home-tab">
                        @include('pages.include.pcg.loan_detail')
                    </div>
                    <div class="tab-pane fade" id="profile1" role="tabpanel" aria-labelledby="profile-tab">
                        @include('pages.include.pcg.scoring')
                    </div>
